...
export function HomeNewsletterBar() {
  return (
    <section className="relative overflow-hidden bg-[#0F1E3D] px-3 py-10 sm:px-4">
      <div
        className="pointer-events-none absolute -right-20 top-0 h-full w-1/3 bg-gradient-to-l from-[#ff6c00]/20 to-transparent"
        aria-hidden
      />
      <div className="relative mx-auto flex max-w-8xl flex-col items-center gap-6 md:flex-row md:justify-between">
