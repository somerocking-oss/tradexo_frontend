...
export async function getListingsCityMetadata(sp: Params, city: string): Promise<Metadata> {
  const merged = { ...sp, city };
...
export async function ListingsCityPageContent({
  sp,
  city,
  page,
}: {
  ...
  const merged = { ...sp, city, page: String(page) };
